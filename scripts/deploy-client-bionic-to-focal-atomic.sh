#!/usr/bin/env bash
# Atomic deploy of bionic→focal approved client artifacts:
...
ARTIFACT="${ROOT}/artifacts/client/dp-offline-upgrade-bionic-to-focal.sh"
SHAFILE="${ARTIFACT}.sha256"
HOP_DIR="${ROOT}/artifacts/client/bionic-to-focal"
HOP_NAME="bionic-to-focal"
...
spec = importlib.util.spec_from_file_location("build_client_b2f", build_py)
