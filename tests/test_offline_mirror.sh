...
[[ -f "${ROOT}/scripts/download-dp-phase2.sh" ]] || fail "missing download-dp-phase2.sh"
...
[[ -f "${ROOT}/client/stage-dp-phase2.sh" ]] || fail "missing stage-dp-phase2.sh"
[[ -f "${ROOT}/client/stage-dp-phase2-6.5.0.sh" ]] || fail "missing stage-dp-phase2-6.5.0.sh"
bash -n "${ROOT}/scripts/download-dp-phase2.sh"
bash -n "${ROOT}/scripts/download-dp-phase2-6.5.0.sh"
bash -n "${ROOT}/client/stage-dp-phase2.sh"
